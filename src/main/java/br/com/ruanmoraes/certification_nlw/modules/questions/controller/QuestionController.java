package br.com.ruanmoraes.certification_nlw.modules.questions.controller;
...
import br.com.ruanmoraes.certification_nlw.modules.questions.dto.AlternativesResultDTO;
import br.com.ruanmoraes.certification_nlw.modules.questions.dto.QuestionResultDTO;
import br.com.ruanmoraes.certification_nlw.modules.questions.entities.AlternativesEntity;
...
public class QuestionController {
    ...
    static QuestionResultDTO mapQuestionToDTO(QuestionEntity question) {
        ...
        List<AlternativesResultDTO> alternativesResultDTOs = question.getAlternatives().stream()
                .map(alternative -> mapAlternativesToDTO(alternative)).collect(Collectors.toList());
